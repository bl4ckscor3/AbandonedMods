...
public class GlowScarecrowHead extends BlockDirectional
{
	...
	public GlowScarecrowHead(Material mat)
	{
		super(mat);
	...
	{
		if (par1World.getBlock(x, y - 1, z) == Scarecrow.scBody && par1World.getBlock(x, y - 2, z) == Blocks.fence)
		{
			...
			if (flag || flag1)
			{
				...
				EntitySmallScarecrow entityirongolem = new EntitySmallScarecrow(par1World);
	...
	{
		this.field_94475_c = par1IconRegister.registerIcon("minecraft:pumpkin_face_on");
